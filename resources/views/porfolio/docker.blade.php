...
<div class="content">
    ...
    <p>If you work as developer, you need also resolve te problem of install your environments yourserf.</p>
    ...
    <p>The red square is the image1.</p>
    <p>The green square is the image2.</p>
    ...
    <p>This is great! But, what about if in your own computer an Application-B?</p>
    <div class="app-b">
        <span>Aplication-B</span>
        <div class="os">
            <span>Operative System I</span>
        </div>
    </div>
    ...
    <p>The Operative System I, is into the image of the Service, and into the Aplication-A.</p>
    ...
    <p>If there is a container running it is not posible delete them, unless you force to delete the images and all their containers.</p>
    ...
    <p>As you can see, Docker work use Layers to build the images.</p>
    ...
    <p>This is not only posible, but also desirable!!!</p>
